...
연-기업 셀은 문서 3건 이상, 축 점수는 그 해 상위 3건 평균(그 해 가장 강하게 말한 수준). 3개 연도 이상 관측된 채널만 싣는다. 전체는 `analysis/aitf_company_year.csv`.

**셀 변화**는 자동화·증강·데이터 순 좌표이며, 판정은 코퍼스 상대 절단점을 그대로 쓴다.

| 기업(채널) | 관측 연도 | 3축 합 추이 | 총 변화 | 최근 셀 |
|---|---|---|---|---|
| Pinecone | 4 | 2022:4.7 → 2023:17.0 → 2024:20.7 → 2025:17.3 | +12.7 | L-H-H |
| Intel | 3 | 2024:6.3 → 2025:25.0 → 2026:11.7 | +5.3 | H-H-L |
| Boston Dynamics | 3 | 2023:3.0 → 2024:7.0 → 2025:7.0 | +4.0 | L-L-L |
| Reckitt | 4 | 2020:0.0 → 2021:0.0 → 2024:0.0 → 2025:4.0 | +4.0 | L-L-L |
| Scale AI | 4 | 2020:0.0 → 2022:3.3 → 2024:0.0 → 2025:3.3 | +3.3 | L-L-L |
| LG AI Research | 4 | 2020:3.7 → 2021:8.3 → 2022:16.0 → 2025:6.3 | +2.7 | L-L-L |
| Replit | 3 | 2024:3.7 → 2025:10.0 → 2026:5.0 | +1.3 | L-L-L |
| Hugging Face | 3 | 2022:4.7 → 2024:4.3 → 2026:4.7 | +0.0 | L-L-L |
| L'Oréal | 3 | 2023:1.0 → 2025:3.3 → 2026:0.3 | -0.7 | L-L-L |
| AWS Developers | 3 | 2024:12.7 → 2025:7.3 → 2026:9.7 | -3.0 | L-L-L |
| Upstage | 3 | 2021:7.0 → 2024:0.7 → 2025:2.7 | -4.3 | L-L-L |
| NAVER Cloud | 3 | 2023:14.3 → 2024:6.0 → 2025:10.0 | -4.3 | L-L-H |
| Weaviate | 3 | 2024:16.0 → 2025:19.0 → 2026:11.0 | -5.0 | L-L-H |
| Weights & Biases | 3 | 2024:18.3 → 2025:24.0 → 2026:12.3 | -6.0 | H-H-L |
| Unilever | 3 | 2024:10.3 → 2025:0.3 → 2026:0.0 | -10.3 | L-L-L |

축별 이동이 큰 채널(최근 연도 기준 전년 대비):

| 기업(채널) | 연도 | 자동화 | 증강 | 데이터 | 이동 축 |
|---|---|---|---|---|---|
| Intel | 2025 | 9.67 | 8.67 | 6.67 | 증강 +8.0 |
| Pinecone | 2023 | 2.67 | 4.67 | 9.67 | 데이터 +6.0 |
| LG AI Research | 2022 | 6.67 | 1.67 | 7.67 | 자동화 +4.0 |
| Replit | 2025 | 7.0 | 1.0 | 2.0 | 자동화 +4.7 |
| Weights & Biases | 2025 | 8.33 | 7.67 | 8.0 | 증강 +2.0 |
| LG AI Research | 2021 | 2.67 | 1.0 | 4.67 | 데이터 +4.0 |
| Boston Dynamics | 2024 | 6.67 | 0.0 | 0.33 | 자동화 +4.0 |
| NAVER Cloud | 2025 | 2.33 | 2.0 | 5.67 | 데이터 +2.7 |
| Reckitt | 2025 | 4.0 | 0.0 | 0.0 | 자동화 +4.0 |
| Pinecone | 2024 | 2.33 | 8.0 | 10.33 | 증강 +3.3 |
| Scale AI | 2022 | 0.0 | 0.33 | 3.0 | 데이터 +3.0 |
| Scale AI | 2025 | 0.67 | 1.33 | 1.33 | 증강 +1.3 |
| Weaviate | 2025 | 4.33 | 5.67 | 9.0 | 증강 +1.7 |
| AWS Developers | 2026 | 3.67 | 2.33 | 3.67 | 데이터 +1.3 |
| L'Oréal | 2025 | 0.0 | 3.33 | 0.0 | 증강 +3.3 |

# 수집 콘텐츠 검토 보고서 (v6.2, 2026-07-27)

> **4,365건 전체 코퍼스** 기준 분석. 심층 정독 ~1,010건(키워드 126 + 채널 대부분), 대규모 백필 잔여분은 인벤토리 상태.
> 자동분류: **AX 1,139 / DX 78 / AT 8 / 미분류 3,140** (채널 197개, 한국어 다수). 연도: 2020~22 얇음(39/73/82) → 2023:204 / 2024:316 / 2025:786 / 2026:2,865(66%).
> **v6.2 증분(3,865→4,365, +500)**: 신규 substantive 채널 없음(백필 + 투자·거시 키워드 영상 6편). **전량 확증적** — 지도 변경 없음. 소폭 보강: 전력축 냉각 정량(§4.2), 현대차 "자동차 회사 아니다"=정체성화(§0-8).

...
|---|---:|---:|---:|---:|
| S1 digitization(전산화) | 62 | 0.7% | 29 | 1.0% |
| S2 digitalization(디지털화) | 1,482 | 15.8% | 1,158 | 41.7% |
| S3 digital transformation(디지털 전환) | 100 | 1.1% | 77 | 2.8% |
| unassigned(근거 부족) | 7,765 | 82.5% | 1,513 | 54.5% |
...
**읽는 법.** 단계가 배정된 1,264건 중 **S2가 1,158건으로
S3(77건)의 15.0배**다. 즉 이 코퍼스의 AX 담론은 압도적으로 **기존 프로세스의
...
S1(전산화)이 29건으로 희소한 것은 2020년대 코퍼스로서 자연스럽다 —
아날로그→디지털 변환은 이미 지나온 단계이기 때문이다.

`unassigned` 1,513건은 "AX 담론이지만 **단계 언어를 쓰지 않는**"
...
| 2026-04 | 1 | 75 | 6 | 81 |
| 2026-05 | 1 | 114 | 3 | 112 |
| 2026-06 | 1 | 202 | 13 | 174 |
| 2026-07 | 8 | 157 | 14 | 229 |
| 2026-08 | 0 | 42 | 3 | 36 |
...
| **(1) 디지털 자원** | | | |
| res_asset | 14% | 7% | 13% |
| res_agility | 21% | 12% | 29% |
| res_networking | 48% | 27% | 36% |
| res_bigdata | 21% | 17% | 21% |
| **(2) 조직구조** | | | |
| org_hierarchy | 7% | 7% | 14% |
| org_separate_unit | 0% | 3% | 3% |
| org_embedded | 0% | 6% | 16% |
| **(3) 성장전략** | | | |
| growth_penetration | 3% | 3% | 19% |
| growth_cocreation | 3% | 5% | 9% |
| growth_diversification | 3% | 5% | 27% |
| **(4) 지표** | | | |
| kpi_traditional | 28% | 19% | 40% |
| kpi_digital | 10% | 15% | 26% |

## 3. S3 digital transformation(디지털 전환) — 사례 41건 / 28개 회사·채널
...
| 2022-03 | anti_washing | 새로운 기술을 활용해서 기존 질서를 파괴하기도 하지만, 새로운 비즈니스 모델과 성장 플랫폼을 만들어내기도 하죠. | 2 | [영상](https://www.youtube.com/watch?v=fnk7ByPs13A) · [script](../transcripts/channels/Telenor/Sigve_Brekke_and_Erlend_Prestgard,_CEO_of_WG2_How_technologi__fnk7ByPs13A.md) |
| 2021-06 | anti_washing | what we really see now it's that digitalization is accelerating things happens much faster than even us uh thought about before the coffee situation and i'm here with uh with uh sventor holster and we are in very different businesses but there are actually also similarities we are both two global co… | 2 | [영상](https://www.youtube.com/watch?v=qaSx9CLqmPQ) · [script](../transcripts/channels/Telenor/Sigve_Brekke_and_Svein_Tore_Holsether_(CEO,_Yara)_on_how_bus__qaSx9CLqmPQ.md) |
...
### Weights & Biases (2건 · 에이전트·개발도구 · US)
...
| 2026-04 | anti_washing | 이러한 야심찬 비즈니스 모델은 우리가 개발한 범용 AI 운전자 덕분에 가능한 것입니다. | 2 | [영상](https://www.youtube.com/watch?v=k5wgts8y-xU) · [script](../transcripts/channels/Weights_&_Biases/The_$8.6B_Self-Driving_AI_Backed_by_Nvidia_and_Uber_Alex_Ken__k5wgts8y-xU.md) |
...
### Hugging Face (1건 · 파운데이션 모델 · US)

| 월 | 톤 | 근거 문장 (스크립트 발췌) | 신호 | 출처 |
|---|---|---|---:|---|
| 2025-11 | anti_washing | 물론, 기본 제품과 오픈 소스를 기반으로 비즈니스 모델을 구축해야 하지만, PMF 관점에서 보면 그 부분이 이미 정해져 있습니다. | 5 | [영상](https://www.youtube.com/watch?v=aNCLqvTCxeg) · [script](../transcripts/channels/Hugging_Face/The_Power_of_Open_Source_Building_Giants_in_the_Open__aNCLqvTCxeg.md) |
...
| 월 | 톤 | 근거 문장 (스크립트 발췌) | 신호 | 출처 |
|---|---|---|---:|---|
| 2023-09 | washing | 자기소개에서 2년 전까지 이케아에 계셨다고 말씀하셨는데, 이케아는 순환 경제를 위한 다양한 노력을 기울여 회수 프로그램을 포함한 순환 비즈니스 모델을 개발해 왔습니다. | 5 | [영상](https://www.youtube.com/watch?v=lX2NDGB6AB4) · [script](../transcripts/channels/Nissan/Accelerating_toward_a_circular_economy_–_from_idea_to_action__lX2NDGB6AB4.md) |

### Snowflake (1건 · 데이터·컨텍스트·거버넌스 · US)

| 월 | 톤 | 근거 문장 (스크립트 발췌) | 신호 | 출처 |
|---|---|---|---:|---|
| 2025-11 | anti_washing | 그렇다면 AI를 활용하여 양면 시장을 구축하고, 이를 통해 강력한 경쟁 우위를 확보할 수 있다는 말씀이신가요? | 4 | [영상](https://www.youtube.com/watch?v=-HWNc-Hd90U) · [script](../transcripts/channels/Snowflake/The_AI_Blueprint_for_the_Next_Decade_BUILD_2025_Luminary_Con__-HWNc-Hd90U.md) |
...
| 월 | 톤 | 근거 문장 (스크립트 발췌) | 신호 | 출처 |
|---|---|---|---:|---|
| 2026-08 | anti_washing | My clear take is that the strategic adoption of AI agents will redefine business operations, driving efficiency and innovation while creating new opportunities for workers. | 2 | [영상](https://www.youtube.com/watch?v=vfQpQ2PwoEQ) · [script](../transcripts/2026-08-03/The_Business_Impact_of_AI_Agents_Use_Cases,_ROI,_and_Future-__vfQpQ2PwoEQ.md) |

### Siemens (1건 · 물리 AI·자율주행 · DE)

| 월 | 톤 | 근거 문장 (스크립트 발췌) | 신호 | 출처 |
|---|---|---|---:|---|
| 2026-06 | anti_washing | 저희 측에서는 전략 및 혁신 역량, 복잡한 환경에서의 엔드투엔드 배포, 그리고 AI 생태계 관리 및 새로운 비즈니스 모델 측면에서도 풍부한 역량을 제공합니다. | 2 | [영상](https://www.youtube.com/watch?v=AvSNxD9GQH4) · [script](../transcripts/channels/Siemens/Industrial_AI_in_Action_Roland_Busch_Keynote_VivaTech_2026_P__AvSNxD9GQH4.md) |
...
## 4. S2 digitalization(디지털화) — 사례 866건 / 134개 회사·채널

회사(채널)별로 단계 신호가 강한 순으로 최대 3건씩. 근거 문장은 **행동 동사가 든 문장**만 뽑았다(일반론 배제). 전량은 `analysis/verhoef_stages.csv` 참조.

### Zapier (83건 · 에이전트·개발도구 · US)
...
### Weights & Biases (40건 · 에이전트·개발도구 · US)
...
### NVIDIA Developer (30건 · 인프라·칩·전력 · US)
...
| 2025-03 | anti_washing | 여러 동시 실행 환경에서 LLM의 지연 시간을 분석하여 워크플로 배포 방식을 더욱 효율적으로 결정할 수 있습니다. | 13 | [영상](https://www.youtube.com/watch?v=yrqdvBLAI3k) · [script](../transcripts/channels/NVIDIA_Developer/Optimize_Your_AI_Agent_Workflows_with_NVIDIA_NeMo_Agent_Tool__yrqdvBLAI3k.md) |
...
### Databricks (22건 · 데이터·컨텍스트·거버넌스 · US)
...
| 2026-06 | neutral | 브랜드 측과 기업 측 모두에서 상담원을 활용하여 훨씬 더 실시간적이고 개인화된 경험을 제공할 수 있습니다. | 15 | [영상](https://www.youtube.com/watch?v=lpS01YiHqjU) · [script](../transcripts/channels/Databricks/Introducing_Databricks_CustomerLake__lpS01YiHqjU.md) |
...
### Apple Developer (20건 · 에이전트·개발도구 · US)

| 월 | 톤 | 근거 문장 (스크립트 발췌) | 신호 | 출처 |
|---|---|---|---:|---|
| 2026-06 | anti_washing | 하지만 macOS 27에서는 완전히 자율적인 에이전트 워크플로우를 지원하는 새로운 명령줄 도구가 도입되었습니다. | 17 | [영상](https://www.youtube.com/watch?v=CKk6K08O76E) · [script](../transcripts/channels/Apple_Developer/WWDC26_Speedrun_your_game_port_with_agentic_coding_Apple__CKk6K08O76E.md) |
...
### AWS Developers (19건 · 에이전트·개발도구 · US)
...
### GitHub (17건 · 에이전트·개발도구 · US)

| 월 | 톤 | 근거 문장 (스크립트 발췌) | 신호 | 출처 |
|---|---|---|---:|---|
| 2026-07 | anti_washing | 개별적인 문제들을 누구나 따라할 수 있는 실행 가능한 워크플로로 전환합니다 . | 51 | [영상](https://www.youtube.com/watch?v=zZuqjoLEYzo) · [script](../transcripts/channels/GitHub/A_complete_beginner's_guide_to_mastering_GitHub__zZuqjoLEYzo.md) |
...
| 2026-03 | neutral | [음악] 이 영상이 끝나면 GitHub Actions를 사용하는 방법과 첫 번째 자동화 워크플로를 만드는 방법을 알게 될 것입니다. | 34 | [영상](https://www.youtube.com/watch?v=BQrohJ3PT7I) · [script](../transcripts/channels/GitHub/How_to_use_GitHub_Actions_GitHub_for_Beginners__BQrohJ3PT7I.md) |
...
### Snowflake (13건 · 데이터·컨텍스트·거버넌스 · US)
...
### Meta Developers (12건 · 에이전트·개발도구 · US)
...
| 2025-08 | anti_washing | That's actually a good transition to why&nbsp;&nbsp; the ontology is such a good foundation for this&nbsp; workflows because as you said when we start those&nbsp;&nbsp; processes when we start this transformation what&nbsp; we do is we the first thing is we connect to the&nbsp;&nbsp; ERP right we're… | 9 | [영상](https://www.youtube.com/watch?v=F57OKeI7JAU) · [script](../transcripts/channels/Palantir/Chad_&_Agathe_How_Palantir_Powers_AI_Automation_Across_Procu__F57OKeI7JAU.md) |
...
| 2026-07 | anti_washing | 어 업무 프로세스를 새롭게 디자인하는 부분들 그리고 어이 프로세스를 디자인하 것들대로 구현을 하기 위해서 에이전트를 개발하고 에이전트를 운영하는 단계 그러면 그 수없이 많은 에이전트들이 생겨나 텐데 그런 에이전트들 어떻게 관리해 나가고 거버넌스를 가져갈 것이냐에 대한 부분도 중요할 것이고 또 한편으로는 이런 에이전트가 효율적으로 잘 사용되기 위해서는 기업이 업무에서 발생하고 있는 고객 접점에서 발생하고 있는 다양한 데이터들을 를 어떻게 에이전트가 잘 쓸 수 있게끔 AI 레디 데이터로 전환시킬 거냐에 대한 부분도 고달할 포인트이고요. | 12 | [영상](https://www.youtube.com/watch?v=Y-ApGj-9ceI) · [script](../transcripts/2026-07-26/AI-Native_기업으로_전환_전략과_사례__Y-ApGj-9ceI.md) |
...
| 2022-09 | neutral | 또 다른 예로 시스템 통합업체와 컨설턴트가 개발한 턴키 솔루션을 들 수 있습니다. | 2 | [영상](https://www.youtube.com/watch?v=u-hbE8vRNw8) · [script](../transcripts/channels/Telenor/Telco_Tech_Talks_Why_is_Amazon_so_successful__u-hbE8vRNw8.md) |
...
| 월 | 톤 | 근거 문장 (스크립트 발췌) | 신호 | 출처 |
|---|---|---|---:|---|
| 2026-07 | anti_washing | 그래서 저희가 23년부터 준비해서 24년에 이제 시스템을 오픈해 나가면서요 밑에 보시면 24, 25, 26, 27 이렇게 진행을 지금 로드맵들을 저희는 하고 있는데 어 24년에 진행했던 것은 상담원을 대체는 어렵다. | 14 | [영상](https://www.youtube.com/watch?v=mHbsngztlHw) · [script](../transcripts/2026-07-21/[AI&CLOUD2026]_세션1_AI-Native_기업으로의_전환_방안_및_사례_삼성SDS_신계영_AX센터__mHbsngztlHw.md) |
...
| 월 | 톤 | 근거 문장 (스크립트 발췌) | 신호 | 출처 |
|---|---|---|---:|---|
| 2026-08 | anti_washing | Top down meaning you've got your AI SWAT team or tiger team focused on significant business process automation. | 9 | [영상](https://www.youtube.com/watch?v=20lqu-d4cxc) · [script](../transcripts/2026-08-03/Closing_the_Enterprise_AI_ROI_Gap__20lqu-d4cxc.md) |
...
## 5. S1 digitization(전산화) — 사례 17건 / 11개 회사·채널
...
| 2026-07 | neutral | 또한, 우리가 추진하고 있는 디지털화의 일환으로 병원에는 풍부한 데이터가 있기 때문에 데이터 기반 의사결정 시스템을 도입하고자 합니다. | 2 | [영상](https://www.youtube.com/watch?v=Fii9aqiUUVk) · [script](../transcripts/channels/Huawei/How_Digital_Infrastructure_Brings_Cardiac_Care_to_Rural_Area__Fii9aqiUUVk.md) |
...
| AI:ROI Conversations with Section | 2026-08 | S2 digitalization(디지털화) | anti_washing | It'll just be a net cut in terms of headcount. | 6 | [영상](https://www.youtube.com/watch?v=20lqu-d4cxc) · [script](../transcripts/2026-08-03/Closing_the_Enterprise_AI_ROI_Gap__20lqu-d4cxc.md) |
